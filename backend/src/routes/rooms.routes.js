...
import { listRooms, createRoom, updateRoom, deleteRoom, availability } from '../controllers/rooms.controller.js';

const router = Router();

router.get('/', requireAuth, withUser, listRooms);
router.get('/availability', requireAuth, withUser, availability);
